...
if($domiciliario -> getEstado() == 1){
    ...
    $log = new Log($_GET["idSesion"] . "." . $_GET["idDomiciliario"],"cambiar/deshabilitar","cambiar estado domiciliario: " . $_GET["nombre"] , date('Y-m-d'),date('H:i:s'),"administrador");
    $log -> crear();
}else{
    ...
    $log = new Log($_GET["idSesion"] . "." . $_GET["idDomiciliario"],"cambiar/habilitar","cambiar estado domiciliario: " . $_GET["nombre"] , date('Y-m-d'),date('H:i:s'),"administrador");
    $log -> crear();
}
?>
